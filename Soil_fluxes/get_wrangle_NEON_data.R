...
# Soil temperature, DP1.00041.001
  zipsByProduct(dpID="DP1.00041.001", site="HARV", package="basic", check.size=F, avg=30) +
    stackByTable(paste0(dir, "/filesToStack00041"), folder=T, saveUnzippedFiles = F)
  file.list1 <- list.files(path = paste0(dir, "/filesToStack00041/stackedFiles"), pattern="tsoi", full.names = TRUE)
...
# Soil water content, DP1.00094.001
  zipsByProduct(dpID="DP1.00094.001", site="HARV", package="basic", check.size=F, avg=30) +
    stackByTable(paste0(dir, "/filesToStack00094"), folder=T, saveUnzippedFiles = F)
  
# Soil CO2 flux, DP4.50036.001  
  zipsByProduct(dpID="DP4.50036.001", site="HARV", package="basic", check.size=F) +
    stackByTable(paste0(dir, "/filesToStack50036"), folder=T, saveUnzippedFiles = F)
